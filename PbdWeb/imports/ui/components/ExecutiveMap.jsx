...
const ExecutiveMap = (props) => {
	...
	function createMap() {
		...
		markerElement.style.marginLeft = '-11px';
		markerElement.style.marginTop = '-57px';
		markerElement.style.position = 'absolute';

		markerElement.innerHTML = 	`<div style="margin-left: calc(-50% + 11px);">
										<div style="font-size: 18px; background: #e3e3e3; display: inline-block; border: 1px solid #999; padding: 3px 6px; border-radius: 3px;">${props.executiveName || ""}</div>
									</div>
